...
<body class="host_version"> 
    ...
    <div id="overviews" class="section lb">
        ...
        <!---Add a paragraph below that with a description of the web development process. Use our class lectures and notes or my description---->

        <p>The webdevelopment process is a systematic process that is used to design and build a website. Planning goes into not just cars, 
            buildings, and cities but also websites. A good process ensures that a quality product with everything the customer asks for is delivered in a timely cost effective manner.
        </p>
        ...
        <!---add the paragraph your see in the screenshot here in this handout below that.---->

        <p>The Web development process can be thought of as a Software Development Life Cyce(SDLC) and project management methodology. The waterfall model 
            depicted below is a long standing, traditional SDLC, characterized by sequential steps. Agile is the newer method that is intended to more quickly 
            respond to changing customer and product requirements using an incremental process with frequent releases and customer feedback. 
        </p>
