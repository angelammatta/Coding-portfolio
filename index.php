...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
     ...
     <!-- Site Metas -->
    <title>Angela Matta ePortfolio</title>  
	...
	<div id="carouselExampleControls" class="carousel slide bs-slider box-slider" data-ride="carousel" data-pause="hover" data-interval="false" >
		...
		<div class="carousel-inner" role="listbox">
							...
							<div class="row">
								<div class="col-md-12 col-sm-12 text-right">
									<div class="big-tagline">
										<h2><strong>Angela</strong> Matta</h2>
										<p class="lead">Game Developer, Software Engineer, AI Programmer, Data Scientist </p>
			...
			<div class="carousel-item">
				<div id="home" class="first-section" style="background-image:url('images/slider-05.jpg');">
					<div class="dtab">
						<div class="container">
							<div class="row">
								<div class="col-md-12 col-sm-12 text-left">
									<div class="big-tagline">
										<h2 data-animation="animated zoomInRight"> <strong>Passionate</strong></h2>
										<p class="lead" data-animation="animated fadeInLeft">Puts her full effort into her projects and strives for the best quality </p>
			...
			<div class="carousel-item">
				<div id="home" class="first-section" style="background-image:url('images/slider-04.jpg');">
					<div class="dtab">
						<div class="container">
							<div class="row">
