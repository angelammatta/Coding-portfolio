				...
				<div class="collapse navbar-collapse" id="navbars-host">
				    <ul class="navbar-nav ml-auto">
                      ...
                      <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="dropdown-a" datatoggle="dropdown">Web Projects </a>
                            <div class="dropdown-menu" aria-labelledby="dropdown-a">
                            <a class="dropdown-item" href="clientserver.php">Client Server </a>
                            ...
                            <a class="dropdown-item" href="security.php">Security News </a>
                            <a class="dropdown-item" href="https://cislinux.hfcc.edu/~amatta1/menu/">Restaurant Menu</a>
                            </div>
                       </li>
                       <li class="nav-item"><a class="nav-link" href="contact.php">Contact Me</a></li>
                    </ul>
                    <ul class="nav navbar-nav navbar-right">
                      <li><a class="hover-btn-new log" href="#" data-toggle="modal" datatarget="#login"><span>Login</span></a></li>
                    </ul>
